...
mixin _$LoadableState<T> {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is LoadableState<T>);
  }
...
class $LoadableStateCopyWith<T, $Res> {
  $LoadableStateCopyWith(
      LoadableState<T> _, $Res Function(LoadableState<T>) __);
}

/// @nodoc

class Initial<T> implements LoadableState<T> {
  const Initial();
...
class Loading<T> implements LoadableState<T> {
  const Loading();
...
class Success<T> implements LoadableState<T> {
...
class Error<T> implements LoadableState<T> {
